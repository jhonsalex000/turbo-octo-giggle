...
<a class="mobile-menu" id="mobile-collapse1" href="#!">
        ...
        <li class="notification">
        <div class="media">
        <img class="img-radius" src="Vistas/assets/images/user/avatar-3.jpg" alt="Generic placeholder image">
        <div class="media-body">
        <p><strong>Sara Soudein</strong>
        ...
        <li><a href="#!" class="displayChatbox">
        <i class="icon feather icon-mail"></i></a></li>
        <li>
        ...
        <div class="pro-head">
        <img src="Vistas/assets/images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
        <span>John Doe</span>
        <a href="desconectar.php" class="dud-logout" title="Logout">
       ...
       <li><a href="#!" class="dropdown-item">
        ...
        <li><a href="message.html" class="dropdown-item">
